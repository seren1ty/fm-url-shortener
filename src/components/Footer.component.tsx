  ...
  return (
    <FooterContainer>
      ...
      <MenuContainer>
        ...
        <SubMenuItem>Link Shortening</SubMenuItem>
        <SubMenuItem>Branded Links</SubMenuItem>
      ...
      <MenuContainer>
        ...
        <SubMenuItem>Developers</SubMenuItem>
        <SubMenuItem>Support</SubMenuItem>
      </MenuContainer>
      <MenuContainer>
        <Box pb={1}>
          Company
      ...
      <Box display="flex" justifyContent="space-between">
        <ShareIcon>
          <ShareLogo src={FacebookIcon} alt="Facebook Share"/>
        </ShareIcon>
        <ShareIcon>
          <ShareLogo src={TwitterIcon} alt="Twitter Share"/>
        </ShareIcon>
        <ShareIcon>
          <ShareLogo src={PinterestIcon} alt="Pinterest Share"/>
        </ShareIcon>
        <ShareIcon>
          <ShareLogo src={InstagramIcon} alt="Instagram Share"/>
        </ShareIcon>
      </Box>
    </FooterContainer>
  )
